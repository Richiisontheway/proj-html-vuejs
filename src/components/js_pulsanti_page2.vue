        ...
        <div class="row">
            <div class="col">
                <div class="illustration--img_container">
                    <img src="../../public/img/h-2-port-img-6.jpg" alt="">
                </div>
            </div>
            <div class="col">
